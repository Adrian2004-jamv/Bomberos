...
class InterfazInventarioTests(TestCase):
    ...
    def test_usuario_y_cierre_de_sesion_estan_en_menu_lateral(self):
        ...
        # Se comprueba que la hoja se enlaza y que lleva marca de versión, no
        # cuál es: fijar el número obliga a tocar esta prueba cada vez que se
        # actualiza un estilo, que es precisamente cuando debe seguir pasando.
        self.assertRegex(respuesta.content.decode(), r"css/componentes\.css\?v=\d+")
        contenido = respuesta.content.decode()

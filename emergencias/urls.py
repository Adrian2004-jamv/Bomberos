...
urlpatterns = [
    ...
    path("exportar/recursos/", views.exportar_recursos, name="exportar_recursos"),
    ...
    path("api/despliegues/<int:pk>/detener-gps/", views.detener_transmision_gps, name="detener_transmision"),
]
